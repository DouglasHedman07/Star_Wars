...
class RecyclerViewAdapterFilms : RecyclerView.Adapter<StarWarsListViewHolder>() {
    var listaStarWars = listOf<FilmsResponse.StarWarsItem>()
    ...
    override fun onBindViewHolder(holder: StarWarsListViewHolder, position: Int) {
        holder.nombreElemento.text = listaStarWars[position].title
    }
